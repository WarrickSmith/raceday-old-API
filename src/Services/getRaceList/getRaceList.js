const getRaceList = (raceMeetings) => {
  ...
  // Function to read Australian date/time and convert to NZ time for storing in raceList array. hard coded to 2hrs difference. Will need to pdtae to use a better date/time conversion library.
